...
?>
	...
	<?php if ( $woo_options['woo_about'] == 'true' && ( is_home() || is_front_page() ) && ! is_paged() ): ?>
	...
	if ( isset($woo_options['woo_slider']) && $woo_options['woo_slider'] == 'true' && (is_home() || is_front_page()) ) {
	
		if ( isset($woo_options['woo_featured_tags']) && $woo_options['woo_featured_tags'] != '' ) { get_template_part( 'includes/featured' ); } else { get_template_part( 'includes/featured-error' ); }
