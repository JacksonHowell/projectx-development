...
class Woo_Twitter extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?><div class="back"><ul id="twitter_update_list_<?php echo $unique_id; ?>"><li></li></ul>
			<p><a href="http<?php ( is_ssl() ? 's' : '' ) ?>://twitter.com/<?php echo $username; ?>"><?php _e('Follow','woothemes'); ?> <strong>@<?php echo $username; ?></strong> <?php _e('on Twitter','woothemes'); ?></a></p></div><div class="clear"></div><?php
