                			...
                			<div class="location-twitter fix">
						    	...
						    	<section id="office-location" class="col-left">
									...
									<ul>
										...
										<?php if (isset($woo_options['woo_contact_email']) && $woo_options['woo_contact_email'] != '') { ?><li><?php _e('Email:','woothemes'); ?> <a href="mailto:<?php echo $woo_options['woo_contact_email']; ?>"><?php echo $woo_options['woo_contact_email']; ?></a></li><?php } ?>
									</ul>
						    	</section>
						    	<?php } ?>
